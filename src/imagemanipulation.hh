...
struct ImageManipulation {
    ...
    virtual SDL_Texture* manipulate(SDL_Texture* origin, SDL_Rect const& rect) const = 0;
};
...
struct ExtractShadow : ImageManipulation {
    ...
    SDL_Texture* manipulate(SDL_Texture* origin, SDL_Rect const& rect) const override;
